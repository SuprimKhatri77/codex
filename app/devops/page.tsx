...
export const metadata: Metadata = {
  title: "Devops",
  description:
    "devops notes — CI/CD, infrastructure as code, monitoring, best practices",
};

export default function DevopsPage() {
  const all = getAllNotes();
  const devopsNotes = all.filter((n) => n.href.startsWith("/devops"));

  const grouped = devopsNotes.reduce<Record<string, Note[]>>((acc, note) => {
